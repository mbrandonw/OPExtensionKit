...
-(void) drawInRect:(CGRect)rect parentBounds:(CGRect)bounds {
  ...
  CGContextSaveGState(c);
  {
    ...
    CTFrameRef topFrame = CTFramesetterCreateFrame(framesetterRef, CFRangeMake(0,0), topFramePath, NULL);
...
-(CTFramesetterRef) framesetterRef {
  return CTFramesetterCreateWithAttributedString((__bridge CFAttributedStringRef)self);
}
